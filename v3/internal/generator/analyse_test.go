...
func TestAnalyser(t *testing.T) {
	...
	for _, entry := range entries {
		...
		for i := range test.want {
			test.want[i] = path.Clean("github.com/KrakenTech-LLC/wails/v3/internal/generator/testcases/" + test.name + test.want[i])
		}
	...
	for _, test := range tests {
		pkgPattern := "github.com/KrakenTech-LLC/wails/v3/internal/generator/testcases/" + test.name
