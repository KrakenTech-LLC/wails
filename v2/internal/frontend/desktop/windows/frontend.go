...
import (
	...
	"github.com/KrakenTech-LLC/wails/v2/internal/binding"
	"github.com/KrakenTech-LLC/wails/v2/internal/frontend"
	"github.com/KrakenTech-LLC/wails/v2/internal/frontend/desktop/windows/win32"
	"github.com/KrakenTech-LLC/wails/v2/internal/frontend/desktop/windows/winc"
	"github.com/KrakenTech-LLC/wails/v2/internal/frontend/desktop/windows/winc/w32"
	wailsruntime "github.com/KrakenTech-LLC/wails/v2/internal/frontend/runtime"
	"github.com/KrakenTech-LLC/wails/v2/internal/logger"
	"github.com/KrakenTech-LLC/wails/v2/internal/system/operatingsystem"
	"github.com/KrakenTech-LLC/wails/v2/pkg/assetserver"
	"github.com/KrakenTech-LLC/wails/v2/pkg/assetserver/webview"
	"github.com/KrakenTech-LLC/wails/v2/pkg/options"
	"github.com/KrakenTech-LLC/wails/v2/pkg/options/windows"
...
func (f *Frontend) Run(ctx context.Context) error {
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			// depends on the content in the WebView, see https://github.com/KrakenTech-LLC/wails/issues/1319
