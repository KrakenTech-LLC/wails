...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/KrakenTech-LLC/wails/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/KrakenTech-LLC/wails/v2 " + desiredVersion))
