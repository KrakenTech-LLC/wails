...
import (
	_ "github.com/KrakenTech-LLC/wails/v2/internal/goversion" // Add Compile-Time version check for minimum go version
	"github.com/KrakenTech-LLC/wails/v2/pkg/application"
